...
<body>
    @foreach ($nilais as $index => $nilai)
        <div class="print-page" style="page-break-after: {{ $index < count($nilais) - 1 ? 'always' : 'auto' }};">
            @php
                // Prepare variables for the included print view
                $datamedis = $nilai->datamedis ?? null;
                $absensi = $nilai->absensi_data ?? null;
            @endphp

            {{-- Include the existing print view content inline --}}
            <div class="container">
                <!-- Header -->
                <div class="header">
            ...
            <div class="signature-section" style="margin-bottom:0px; flex-wrap: wrap;">
                ...
                <div class="signature-box">
                    ...
                    <div class="signature-line" style="flex-direction: column; gap: 4px;">
                        ...
                        <p style="margin-top: 0; display: block; font-size:7pt">NUPTK: {{ $nilai->guru?->nuptk ?? '-' }}</p>
                    </div>
                </div>
            </div>
            <div style="display: flex; justify-content: center; margin-top: 5px;">
                <div class="signature-box">
                    ...
                    <div class="signature-line" style="flex-direction: column; gap: 4px;">
                        ...
                        <p style="margin-top: 0; display: block;font-size:7pt">NUPTK: {{ $sekolah->guru?->nuptk ?? '-' }}</p>
                    </div>
                </div>
            </div>
            <!-- Print Information -->
