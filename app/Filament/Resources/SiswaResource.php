...
class SiswaResource extends Resource
{
                    ...
                    ->schema([
                        Forms\Components\Grid::make(2)
                            ->schema([
                                ...
                                Forms\Components\Placeholder::make('nis_info')
                                    ->label('Info NIS')
                ...
                Section::make('Alamat Siswa')
                    ...
                    ->schema([
                        ...
                        Select::make('provinsi_id')
                            ...
                            ->native(false)
                            ->live()
                            ->afterStateUpdated(fn(Forms\Set $set) => $set('kota_id', null)),
                        ...
                        Select::make('kota_id')
                            ...
                            ->native(false)
                            ->live()
                            ->afterStateUpdated(fn(Forms\Set $set) => $set('kecamatan_id', null)),
                        ...
                        Select::make('kecamatan_id')
                            ...
                            ->native(false)
                            ->live()
                            ->afterStateUpdated(fn(Forms\Set $set) => $set('kelurahan_id', null)),
        ...
        return $table
            ...
            ->actions([
                ...
                ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('print-cover')
                        ->label('Print Cover')
    ...
    public static function getPages(): array
    {
        return [
            ...
            'print-report' => Pages\PrintReport::route('/print-report'),
        ];
    }
